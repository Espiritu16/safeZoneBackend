...
--
-- Current Database: `safezonedb`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `safezonedb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Dumping data for table `asignaciones_caso`
--

LOCK TABLES `asignaciones_caso` WRITE;
/*!40000 ALTER TABLE `asignaciones_caso` DISABLE KEYS */;
/*!40000 ALTER TABLE `asignaciones_caso` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `catalogo_tipos_seguimiento`
--

LOCK TABLES `catalogo_tipos_seguimiento` WRITE;
/*!40000 ALTER TABLE `catalogo_tipos_seguimiento` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogo_tipos_seguimiento` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `catalogo_tipos_violencia`
--

LOCK TABLES `catalogo_tipos_violencia` WRITE;
/*!40000 ALTER TABLE `catalogo_tipos_violencia` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalogo_tipos_violencia` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `denuncia_adjuntos`
--

LOCK TABLES `denuncia_adjuntos` WRITE;
/*!40000 ALTER TABLE `denuncia_adjuntos` DISABLE KEYS */;
/*!40000 ALTER TABLE `denuncia_adjuntos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `evaluaciones_riesgo`
--

LOCK TABLES `evaluaciones_riesgo` WRITE;
/*!40000 ALTER TABLE `evaluaciones_riesgo` DISABLE KEYS */;
/*!40000 ALTER TABLE `evaluaciones_riesgo` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `medidas_proteccion`
--

LOCK TABLES `medidas_proteccion` WRITE;
/*!40000 ALTER TABLE `medidas_proteccion` DISABLE KEYS */;
/*!40000 ALTER TABLE `medidas_proteccion` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `seguimientos_caso`
--

LOCK TABLES `seguimientos_caso` WRITE;
/*!40000 ALTER TABLE `seguimientos_caso` DISABLE KEYS */;
/*!40000 ALTER TABLE `seguimientos_caso` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-25  6:20:58
